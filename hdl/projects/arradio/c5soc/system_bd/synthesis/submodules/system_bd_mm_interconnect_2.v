...
module system_bd_mm_interconnect_2 (
		...
		input  wire [127:0] axi_adc_dma_m_dest_axi_wdata,                                        //                                                              .wdata
		input  wire [15:0]  axi_adc_dma_m_dest_axi_wstrb,                                        //                                                              .wstrb
		...
		output wire [127:0] axi_adc_dma_m_dest_axi_rdata,                                        //                                                              .rdata
		...
		output wire [127:0] sys_hps_f2h_sdram1_data_wdata,                                       //                                                              .wdata
		output wire [15:0]  sys_hps_f2h_sdram1_data_wstrb,                                       //                                                              .wstrb
		...
		input  wire [127:0] sys_hps_f2h_sdram1_data_rdata,                                       //                                                              .rdata
		...
		input  wire         axi_adc_dma_m_dest_axi_id_pad_clk_reset_reset_bridge_in_reset_reset, // axi_adc_dma_m_dest_axi_id_pad_clk_reset_reset_bridge_in_reset.reset
	...
	altera_merlin_axi_translator #(
		...
		.S0_LOCK_WIDTH                     (2),
		.S0_AXI_VERSION                    ("AXI3")
	) axi_adc_dma_m_dest_axi_id_pad (
		.aclk        (sys_dma_clk_clk_clk),                                                  //       clk.clk
		.aresetn     (~axi_adc_dma_m_dest_axi_id_pad_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset_n
		...
		.s0_awid     (axi_adc_dma_m_dest_axi_awid),                                          //        s0.awid
		.s0_awaddr   (axi_adc_dma_m_dest_axi_awaddr),                                        //          .awaddr
		.s0_awlen    (axi_adc_dma_m_dest_axi_awlen),                                         //          .awlen
		.s0_awsize   (axi_adc_dma_m_dest_axi_awsize),                                        //          .awsize
		.s0_awburst  (axi_adc_dma_m_dest_axi_awburst),                                       //          .awburst
		.s0_awlock   (axi_adc_dma_m_dest_axi_awlock),                                        //          .awlock
		.s0_awcache  (axi_adc_dma_m_dest_axi_awcache),                                       //          .awcache
		.s0_awprot   (axi_adc_dma_m_dest_axi_awprot),                                        //          .awprot
		.s0_awvalid  (axi_adc_dma_m_dest_axi_awvalid),                                       //          .awvalid
		.s0_awready  (axi_adc_dma_m_dest_axi_awready),                                       //          .awready
		.s0_wid      (axi_adc_dma_m_dest_axi_wid),                                           //          .wid
		.s0_wdata    (axi_adc_dma_m_dest_axi_wdata),                                         //          .wdata
		.s0_wstrb    (axi_adc_dma_m_dest_axi_wstrb),                                         //          .wstrb
		.s0_wlast    (axi_adc_dma_m_dest_axi_wlast),                                         //          .wlast
		.s0_wvalid   (axi_adc_dma_m_dest_axi_wvalid),                                        //          .wvalid
		.s0_wready   (axi_adc_dma_m_dest_axi_wready),                                        //          .wready
		.s0_bid      (axi_adc_dma_m_dest_axi_bid),                                           //          .bid
		.s0_bresp    (axi_adc_dma_m_dest_axi_bresp),                                         //          .bresp
		.s0_bvalid   (axi_adc_dma_m_dest_axi_bvalid),                                        //          .bvalid
		.s0_bready   (axi_adc_dma_m_dest_axi_bready),                                        //          .bready
		.s0_arid     (axi_adc_dma_m_dest_axi_arid),                                          //          .arid
		.s0_araddr   (axi_adc_dma_m_dest_axi_araddr),                                        //          .araddr
		.s0_arlen    (axi_adc_dma_m_dest_axi_arlen),                                         //          .arlen
		.s0_arsize   (axi_adc_dma_m_dest_axi_arsize),                                        //          .arsize
		.s0_arburst  (axi_adc_dma_m_dest_axi_arburst),                                       //          .arburst
		.s0_arlock   (axi_adc_dma_m_dest_axi_arlock),                                        //          .arlock
		.s0_arcache  (axi_adc_dma_m_dest_axi_arcache),                                       //          .arcache
		.s0_arprot   (axi_adc_dma_m_dest_axi_arprot),                                        //          .arprot
		.s0_arvalid  (axi_adc_dma_m_dest_axi_arvalid),                                       //          .arvalid
		.s0_arready  (axi_adc_dma_m_dest_axi_arready),                                       //          .arready
		.s0_rid      (axi_adc_dma_m_dest_axi_rid),                                           //          .rid
		.s0_rdata    (axi_adc_dma_m_dest_axi_rdata),                                         //          .rdata
		.s0_rresp    (axi_adc_dma_m_dest_axi_rresp),                                         //          .rresp
		.s0_rlast    (axi_adc_dma_m_dest_axi_rlast),                                         //          .rlast
		.s0_rvalid   (axi_adc_dma_m_dest_axi_rvalid),                                        //          .rvalid
		.s0_rready   (axi_adc_dma_m_dest_axi_rready),                                        //          .rready
