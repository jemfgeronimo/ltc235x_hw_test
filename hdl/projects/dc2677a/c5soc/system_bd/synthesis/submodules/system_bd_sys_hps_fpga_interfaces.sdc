create_clock -period 12.5 [get_pins -compatibility_mode *|fpga_interfaces|clocks_resets|h2f_user0_clk]
...
create_clock -period 10.0 [get_pins -compatibility_mode *|fpga_interfaces|peripheral_i2c0|out_clk]